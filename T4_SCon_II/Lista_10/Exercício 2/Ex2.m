clear; close all; clc;
%% Considere o sistema de controle representado na figura 2. Para esse pro-
% blema, as matrizes A, B, C, D são idênticas àquelas identificas no proble
% ma 1, bem como os critérios de desempenho. Nesse caso, considere que o
% observador de estados é implementado de acordo com a seguinte equação:
...
% XII) Função de transferência simplificada do controlador-observador
s = tf('s'); % cria variável de Laplace s

Gcon = minreal(K/(s*eye(2) - (A-B*K-Ke*C))*Ke,1e-4)
